package me.finn.launchify.commands;

import me.finn.launchify.Launchify;
import me.finn.launchify.arena.LaunchArena;
import me.finn.launchify.commands.subcommands.*;
...
public class LaunchifyCommand implements CommandExecutor, TabCompleter {

    private Launchify pl;

    public LaunchifyCommand(Launchify pl) {
        this.pl = pl;
