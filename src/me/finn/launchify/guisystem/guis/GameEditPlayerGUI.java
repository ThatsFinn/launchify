...
public class GameEditPlayerGUI extends GUI {
    ...
    public GameEditPlayerGUI(PlayerMenuUtility playerMenuUtility, Launchify pl) {
    ...
    public void setMenuItems() {
        LaunchPlayer target = playerMenuUtility.getBPTarget();
    ...
    public void handleMenu(InventoryClickEvent e) {
        ...
        if (e.getAction() == InventoryAction.DROP_ONE_SLOT) {
            switch (item.getType()) {
                case GOLDEN_SWORD:
                    game.kill(target, null, DeathReason.VOID);
